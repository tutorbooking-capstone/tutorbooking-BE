...
namespace App.Repositories.Migrations
{
    ...
    [Migration("20250719114124_AddNumericCodeToDepositTable")]
    partial class AddNumericCodeToDepositTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Repositories.Models.Booking.OfferedSlot", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("App.Repositories.Models.Booking.TutorBookingOffer", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("App.Repositories.Models.Rating.BookingSlotRating", b =>
                {
                    ...
                    b.HasIndex("BookingSlotId")
                        .IsUnique()
                        .HasDatabaseName("ix_booking_slot_ratings_booking_slot_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.Booking.OfferedSlot", b =>
                {
                    b.HasOne("App.Repositories.Models.Booking.TutorBookingOffer", "TutorBookingOffer")
            ...
            modelBuilder.Entity("App.Repositories.Models.Booking.TutorBookingOffer", b =>
                {
                    ...
                    b.HasOne("App.Repositories.Models.Lesson", "Lesson")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_tutor_booking_offers__lessons_lesson_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.Rating.BookingSlotRating", b =>
                {
                    b.HasOne("App.Repositories.Models.Scheduling.BookingSlot", "BookingSlot")
                        ...
                        .HasForeignKey("App.Repositories.Models.Rating.BookingSlotRating", "BookingSlotId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired()
                        .HasConstraintName("fk_booking_slot_ratings__booking_slots_booking_slot_id");
                    ...
                    b.HasOne("App.Repositories.Models.User.Learner", "Learner")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired()
                        .HasConstraintName("fk_booking_slot_ratings__learners_learner_temp_id");
                    ...
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_booking_slot_ratings__tutors_tutor_temp_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.Scheduling.BookingSlot", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Learner", "Learner")
                        ...
                        .HasForeignKey("LearnerId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_booking_slots__learners_learner_temp_id1");
                    ...
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_booking_slots__tutors_tutor_temp_id1");
