...
namespace App.Repositories.Migrations
{
    ...
    [Migration("20250814130912_AddConfig4StaffAndManager")]
    partial class AddConfig4StaffAndManager
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Repositories.Models.Booking", b =>
                {
                    ...
                    b.Property<string>("BookingSlotRatingId")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("App.Repositories.Models.BookingDispute", b =>
                {
                    ...
                    b.Property<string>("LearnerReason")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("learner_reason");

                    b.Property<DateTime>("ReconciliationEndTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("reconciliation_end_time");
                    ...
                    b.Property<DateTime?>("StaffReviewEndTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("staff_review_end_time");
                    ...
                    b.Property<DateTime?>("TutorRespondedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("tutor_responded_at");

                    b.Property<string>("TutorResponse")
                        .HasColumnType("text")
                        .HasColumnName("tutor_response");
                    ...
                    b.HasIndex("StaffId")
                        .HasDatabaseName("ix_booking_disputes_staff_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.DepositRequest", b =>
                {
                    ...
                    b.Property<long?>("NumericOrderCode")
                        .HasColumnType("bigint")
                        .HasColumnName("numeric_order_code");
            ...
            modelBuilder.Entity("App.Repositories.Models.LearnerTimeSlotRequest", b =>
                {
                    ...
                    b.Property<string>("RequestedSlotsJson")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("requested_slots_json");
                    ...
                    b.HasIndex("LessonId")
                        .HasDatabaseName("ix_learner_time_slot_requests_lesson_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.Legal.LegalDocumentAcceptance", b =>
                {
                    ...
                    b.Property<string>("LegalDocumentVersionId")
                        .IsRequired()
                        .HasColumnType("text")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_legal_document_acceptances");

                    b.HasIndex("LegalDocumentId")
                        .HasDatabaseName("ix_legal_document_acceptances_legal_document_id");

                    b.HasIndex("LegalDocumentVersionId")
                        .HasDatabaseName("ix_legal_document_acceptances_legal_document_version_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.Notifications.AppUserNotification", b =>
                {
                    ...
                    b.Property<string>("NotificationEntityId")
                        .HasColumnType("text")
                        .HasColumnName("notification_entity_id");

                    b.Property<DateTime?>("ReadAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("read_at");

                    b.HasKey("AppUserId", "NotificationEntityId");
            ...
            modelBuilder.Entity("App.Repositories.Models.Notifications.NotificationEntity", b =>
                {
                    ...
                    b.Property<int>("NotificationPriority")
                        .HasColumnType("integer")
                        .HasColumnName("notification_priority");
            ...
            modelBuilder.Entity("App.Repositories.Models.Rating.BookingSlotRating", b =>
                {
                    ...
                    b.Property<float>("TeachingQuality")
                        .HasColumnType("real")
                        .HasColumnName("teaching_quality");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_booking_slot_ratings");

                    b.HasIndex("BookingId")
                        .IsUnique()
                        .HasDatabaseName("ix_booking_slot_ratings_booking_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.Scheduling.BookedSlot", b =>
                {
                    ...
                    b.HasIndex("DisputeId")
                        .HasDatabaseName("ix_booked_slots_dispute_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.TutorBookingOffer", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_tutor_booking_offers");

                    b.HasIndex("LearnerId");

                    b.HasIndex("LessonId")
                        .HasDatabaseName("ix_tutor_booking_offers_lesson_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.TutorIntroductionVideo", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_tutor_introduction_videos");

                    b.HasIndex("TutorUserId");

                    b.ToTable("tutor_introduction_videos");
                });
            ...
            modelBuilder.Entity("App.Repositories.Models.User.Manager", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text")
                        .HasColumnName("user_id");

                    b.Property<string>("EncryptedCitizenId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("encrypted_citizen_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.Booking", b =>
                {
                    ...
                    b.HasOne("App.Repositories.Models.User.Learner", "Learner")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_bookings__learners_learner_temp_id1");
            ...
            modelBuilder.Entity("App.Repositories.Models.BookingDispute", b =>
                {
                    ...
                    b.HasOne("App.Repositories.Models.User.Learner", "Learner")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_booking_disputes__learners_learner_temp_id");

                    b.HasOne("App.Repositories.Models.User.AppUser", "Staff")
                        .WithMany()
                        .HasForeignKey("StaffId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_booking_disputes___users_staff_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.HeldFund", b =>
                {
                    b.HasOne("App.Repositories.Models.WithdrawalRequest", "WithdrawalRequest")
                        .WithMany()
                        .HasForeignKey("WithdrawalRequestId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_held_funds__withdrawal_requests_withdrawal_request_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.LearnerTimeSlotRequest", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Learner", "Learner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_learner_time_slot_requests__learners_learner_temp_id3");

                    b.HasOne("App.Repositories.Models.Lesson", "Lesson")
                        .WithMany()
                        .HasForeignKey("LessonId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_learner_time_slot_requests__lessons_lesson_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.Legal.LegalDocumentAcceptance", b =>
                {
                    b.HasOne("App.Repositories.Models.Legal.LegalDocument", "LegalDocument")
                        .WithMany("LegalDocumentAcceptances")
                        .HasForeignKey("LegalDocumentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_legal_document_acceptances_legal_documents_legal_document_id");

                    b.HasOne("App.Repositories.Models.Legal.LegalDocumentVersion", "LegalDocumentVersion")
                        .WithMany("LegalDocumentAcceptances")
                        .HasForeignKey("LegalDocumentVersionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_legal_document_acceptances__legal_document_versions_legal_docu~");
                    ...
                    b.HasOne("App.Repositories.Models.User.AppUser", "AppUser")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_legal_document_acceptances___users_app_user_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.Notifications.AppUserNotification", b =>
                {
                    b.HasOne("App.Repositories.Models.User.AppUser", "AppUser")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired()
                        .HasConstraintName("fk_app_user_notification___users_app_user_id");

                    b.HasOne("App.Repositories.Models.Notifications.NotificationEntity", "NotificationEntity")
                        .WithMany("AppUserNotifications")
                        .HasForeignKey("NotificationEntityId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired()
                        .HasConstraintName("fk_app_user_notification__notification_entities_notification_ent~");
            ...
            modelBuilder.Entity("App.Repositories.Models.Papers.TutorApplication", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Tutor", null)
                        .WithOne("Application")
            ...
            modelBuilder.Entity("App.Repositories.Models.Rating.BookingSlotRating", b =>
                {
                    b.HasOne("App.Repositories.Models.Booking", "Booking")
                        .WithOne("BookingSlotRating")
                        .HasForeignKey("App.Repositories.Models.Rating.BookingSlotRating", "BookingId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired()
                        .HasConstraintName("fk_booking_slot_ratings_bookings_booking_id");

                    b.HasOne("App.Repositories.Models.User.Learner", "Learner")
                        .WithMany("BookingSlotRatings")
                        .HasForeignKey("LearnerId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired()
                        .HasConstraintName("fk_booking_slot_ratings__learners_learner_temp_id2");
            ...
            modelBuilder.Entity("App.Repositories.Models.Scheduling.BookedSlot", b =>
                {
                    ...
                    b.HasOne("App.Repositories.Models.BookingDispute", "Dispute")
                        .WithMany()
                        .HasForeignKey("DisputeId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_booked_slots_booking_disputes_dispute_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.TutorBookingOffer", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Learner", "Learner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tutor_booking_offers__learners_learner_temp_id4");

                    b.HasOne("App.Repositories.Models.Lesson", "Lesson")
                        .WithMany()
                        .HasForeignKey("LessonId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_tutor_booking_offers_lessons_lesson_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.User.Manager", b =>
                {
                    b.HasOne("App.Repositories.Models.User.AppUser", "User")
                        .WithOne()
                        .HasForeignKey("App.Repositories.Models.User.Manager", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_managers___users_user_id");
            ...
            modelBuilder.Entity("App.Repositories.Models.Legal.LegalDocument", b =>
                {
                    b.Navigation("LegalDocumentAcceptances");
            ...
            modelBuilder.Entity("App.Repositories.Models.User.Tutor", b =>
                {
                    ...
                    b.Navigation("IntroductionVideos");
