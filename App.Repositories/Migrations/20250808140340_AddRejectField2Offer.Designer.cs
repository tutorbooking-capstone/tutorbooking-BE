...
namespace App.Repositories.Migrations
{
    ...
    [Migration("20250808140340_AddRejectField2Offer")]
    partial class AddRejectField2Offer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("App.Repositories.Models.LearnerTimeSlotRequest", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Learner", "Learner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_learner_time_slot_requests__learners_learner_temp_id2");
                    ...
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_learner_time_slot_requests__tutors_tutor_temp_id2");
            ...
            modelBuilder.Entity("App.Repositories.Models.Lesson", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_lessons__tutors_tutor_temp_id3");
            ...
            modelBuilder.Entity("App.Repositories.Models.Papers.TutorApplication", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Tutor", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tutor_applications__tutors_tutor_temp_id4");
            ...
            modelBuilder.Entity("App.Repositories.Models.Rating.BookingSlotRating", b =>
                {
                    ...
                    b.HasOne("App.Repositories.Models.User.Learner", "Learner")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired()
                        .HasConstraintName("fk_booking_slot_ratings__learners_learner_temp_id1");
                    ...
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_booking_slot_ratings__tutors_tutor_temp_id1");
            ...
            modelBuilder.Entity("App.Repositories.Models.Scheduling.WeeklyAvailabilityPattern", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_weekly_availability_patterns__tutors_tutor_temp_id8");
            ...
            modelBuilder.Entity("App.Repositories.Models.TutorBookingOffer", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Learner", "Learner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tutor_booking_offers__learners_learner_temp_id3");
                    ...
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tutor_booking_offers__tutors_tutor_temp_id5");
            ...
            modelBuilder.Entity("App.Repositories.Models.TutorHashtag", b =>
                {
                    ...
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tutor_hashtags__tutors_tutor_temp_id6");
            ...
            modelBuilder.Entity("App.Repositories.Models.TutorLanguage", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tutor_languages__tutors_tutor_temp_id7");
