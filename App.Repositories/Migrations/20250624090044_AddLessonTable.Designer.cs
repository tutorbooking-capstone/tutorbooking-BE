...
namespace App.Repositories.Migrations
{
    ...
    [Migration("20250624090044_AddLessonTable")]
            ...
            modelBuilder.Entity("App.Repositories.Models.Lesson", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_lessons__tutors_tutor_temp_id1");
            ...
            modelBuilder.Entity("App.Repositories.Models.Papers.TutorApplication", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired()
                        .HasConstraintName("fk_tutor_applications__tutors_tutor_temp_id2");
            ...
            modelBuilder.Entity("App.Repositories.Models.Scheduling.WeeklyAvailabilityPattern", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_weekly_availability_patterns__tutors_tutor_temp_id5");
            ...
            modelBuilder.Entity("App.Repositories.Models.TutorHashtag", b =>
                {
                    ...
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tutor_hashtags__tutors_tutor_temp_id3");
            ...
            modelBuilder.Entity("App.Repositories.Models.TutorLanguage", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tutor_languages__tutors_tutor_temp_id4");
