...
namespace App.Repositories.Migrations
{
    ...
    [Migration("20250708080707_UpdateLearnerRequestTable")]
    partial class UpdateLearnerRequestTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("App.Repositories.Models.Booking.TutorBookingOffer", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Learner", "Learner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tutor_booking_offers__learners_learner_temp_id2");
                    ...
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tutor_booking_offers__tutors_tutor_temp_id4");
            ...
            modelBuilder.Entity("App.Repositories.Models.Scheduling.WeeklyAvailabilityPattern", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_weekly_availability_patterns__tutors_tutor_temp_id7");
            ...
            modelBuilder.Entity("App.Repositories.Models.TutorHashtag", b =>
                {
                    ...
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tutor_hashtags__tutors_tutor_temp_id5");
            ...
            modelBuilder.Entity("App.Repositories.Models.TutorLanguage", b =>
                {
                    b.HasOne("App.Repositories.Models.User.Tutor", "Tutor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tutor_languages__tutors_tutor_temp_id6");
